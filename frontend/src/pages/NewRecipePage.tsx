...
import { ArrowLeft, Save, AlertCircle, CheckCircle, Plus, X } from "lucide-react";
...
export default function NewRecipePage() {
  ...
  useEffect(() => {
    if (location.state?.parsedData) {
      ...
      // Keep ingredients as HTML from parsing
      ...
      setFormData({
        ...
        difficulty: "",
        source_type: (parsed.source_type as any) || "manual",
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex gap-4">
                <Button 
                  ...
                  disabled={createRecipeMutation.isPending || !formData.title.trim()}
                >
                  <Save size={16} />
              ...
              {createRecipeMutation.error && (
                <div className="bg-destructive/10 border border-destructive/20 rounded-lg p-4">
                  <p className="text-destructive text-sm">
                    Error: {createRecipeMutation.error.message}
                  </p>
                </div>
              )}
            </form>
