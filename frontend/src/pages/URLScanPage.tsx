...
import ParseWithProgress from "@/components/parsing/ParseWithProgress";
                      ...
                      {websiteProtectionError.suggestions.length > 0 && (
                        <div className="mt-4 p-3 bg-orange-100 dark:bg-orange-900/30 rounded-lg">
                          ...
                          <ul className="text-sm text-orange-700 dark:text-orange-300 space-y-1">
                            {websiteProtectionError.suggestions.map(
                              (suggestion, index) => (
                                <li
                                  key={index}
          ...
          <Card className="mt-6">
            <CardContent className="p-6">
              ...
              <div className="space-y-2 text-sm text-muted-foreground">
                <p>
                  • <strong>500+ recipe websites supported</strong>
                </p>
              ...
              <div className="mt-4 p-3 bg-green-50 dark:bg-green-950 rounded-lg">
                <p className="text-sm text-green-700 dark:text-green-300">
                  <strong>Enhanced Parsing:</strong> Our improved parser
                  automatically detects recipe data and formats ingredients and
